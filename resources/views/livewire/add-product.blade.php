...
class extends Component
{
    ...
    public function store()
    {
        ...
        // Generate and assign the UUID before saving
...
<div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
    ...
    <x-mary-form wire:submit="store">
        ...
        <x-slot:actions>
            ...
            <x-mary-button label="Cancel" link="{{ route('dashboard') }}" class="btn-primary dark:bg-zinc-900 rounded-lg border-none hover:bg-zinc-800" wire:navigate/>

            {{-- Submit Button --}}
            <x-mary-button
                label="Save"
                icon="o-paper-airplane"
                spinner="store" {{-- Show spinner while store method is running --}}
