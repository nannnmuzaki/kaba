...
new 
#[Layout('components.layouts.app')] // Use the same layout
...
class extends Component
{
    ...
    public function update()
    {
        ...
        $this->validate([
            ...
            'photo' => 'nullable|image|max:1024', // Photo is optional during edit
        ]);
    ...
    {
        return []; // No extra data needed for the view initially
    }
}; ?>
    ...
    <x-mary-form wire:submit="update">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2"> {{-- Make photo upload span two columns --}}
                <x-mary-file
                    name="photo" {{-- Name attribute for the file input --}}
                    label="Product Photo"
                    hint="Only Image (Optional - Leave empty to keep current image)"
                    wire:model="photo" {{-- Bind to the photo property --}}
                ...
                @if ($currentImage && !$photo)
                    <div class="mt-4">
                        ...
                        <img src="{{ asset('storage/' . $currentImage) }}" class="rounded-md max-w-xs" alt="Current product image" />
                    </div>
                @endif
                ...
                @if ($photo)
                    <div class="mt-4">
                        ...
                        <img src="{{ $photo->temporaryUrl() }}" class="rounded-md max-w-xs" alt="New product image preview" />
                    </div>
                @endif
            </div>
        </div>
        ...
        <x-slot:actions>
            ...
            <x-mary-button 
                ...
                class="btn-primary dark:bg-zinc-900 rounded-lg border-none hover:bg-zinc-800"
                wire:navigate
            />
            ...
            <x-mary-button
                ...
                spinner="update" {{-- Show spinner while update method is running --}}
